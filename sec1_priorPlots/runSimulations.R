...
# ## Centering partition
# # FirstPart= seq(1:20)
# name <- "clusterSpecificRho_constantOverTime"
# FirstPart= rep(c(1,2,3,4), each = 5)
# alpha <- rep(c(0.25, 0.5, 0.75 ,0.95), each = 5)
# nsim <- 5000
...
## Centering partition
# FirstPart= seq(1:20)
name <- "diffRho_constantOverTime_high"
FirstPart= rep(c(1,2,3,4), each = 5)
...
# ## Centering partition
# # FirstPart= seq(1:20)
# name <- "diffRho_constantOverTime_05"
# FirstPart= rep(c(1,2,3,4), each = 5)
# alpha <- rep(c(0.5, 0.5, 0.5 ,0.5), each = 5)
# nsim <- 5000
# clusterSpecific <- FALSE
# source("0_priorSimulationR.R")
